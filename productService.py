    ...
    try:
        ...
        sql = """
            SELECT 
                ...
                product_details.property_value
            FROM product
        ...
        excluded_columns = ["url", "property_name", "property_value"]
        ...
        for row in myresult:
            ...
            property_name = row[column_names.index('property_name')]
            property_value = row[column_names.index('property_value')]
